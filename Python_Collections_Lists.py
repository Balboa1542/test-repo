...
#get_ipython().magic('run quiz1_q1.py')
exec(open(path + "quiz1_q1.py").read())

exec(close(path + "quiz1_q1.py"))
clear_screen()
print("Quiz 1\n"
"Question 2:\n"
...
# Attempt answering the question:
#get_ipython().magic('run quiz1_q2.py')
exec(open(path + "quiz1_q2.py").read())
...
# Attempt answering the question:
#get_ipython().magic('run quiz1_q3.py')
exec(open(path + "quiz1_q3.py").read())
...
# Attempt answering the question:
#get_ipython().magic('run quiz1_q4.py')
exec(open(path + "quiz1_q4.py").read())
...
# Attempt answering the question:
#get_ipython().magic('run quiz1_q5.py')
exec(open(path + "quiz1_q5.py").read())
...
# Attempt answering the question:
#get_ipython().magic('run quiz1_q6.py')
exec(open(path + "quiz1_q6.py").read())
